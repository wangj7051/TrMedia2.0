...
public abstract class AudioPlayService extends BaseAudioService {
    ...
    public void saveTargetMediaPath(String mediaPath) {
        AudioPreferUtils.getAudioLastTargetMediaUrl(true, mediaPath);
    }

    @Override
    public String getLastTargetMediaPath() {
        return AudioPreferUtils.getAudioLastTargetMediaUrl(false, "");
    }
    ...
    public String[] getPlayedMediaInfos() {
        return AudioPreferUtils.getAudioLastPlayedMediaInfo(false, "", 0);
    }

    @Override
    public void clearPlayedMediaInfos() {
        AudioPreferUtils.getAudioLastPlayedMediaInfo(true, "", 0);
    }
    ...
    public void setPlayMode(PlayMode mode) {
        AudioPreferUtils.getAudioPlayMode(true, mode);
        onPlayModeChange();
    }
