...
public class PlayerConsts {
	...
	public interface TabTypes {
		 ...
		 * 媒体列表
		 */
		public final int MEDIA_LIST = 1;
		/**
		 * 文件列表
		 */
		public final int FOLDER_LIST = 2;
		/**
		 * 播放历史记录列表
		 */
		public final int HISTORY_LIST = 2;
	}
	...
	public interface PlayerOpenMethod {
		 ...
		 * 点击Launcher图标打开
		 */
		public final String VAL_LAUCHER_ICON = "LAUNCHER_ICON";
		/**
		 * 点击文件管理器媒体打开
		 */
		public final String VAL_FILE_MANAGER = "FILE_MANAGER";
		/**
		 * ??
		 */
		public final String VAL_ONLINE_MEDIA = "ONLINE_MEDIA";
	}
