...
public class SlcLc2010VdcVideoListAdapter extends BaseArrayAdapter<ProVideo> implements SectionIndexer {
    // TAG
    ...
    public SlcLc2010VdcVideoListAdapter(Context context, int resource) {
        super(context, resource);
        this.mResID = R.layout.slc_lc2010_vdc_activity_video_list_item;
    }
