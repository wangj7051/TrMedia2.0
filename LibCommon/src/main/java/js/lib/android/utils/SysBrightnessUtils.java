 ...
 */
public class SysBrightnessUtils {
	/**
	 * 判断是否开启了自动亮度调节
	 */
	public static boolean IsAutoBrightness(Context context) {
		...
		try {
			IsAutoBrightness = Settings.System.getInt(context.getContentResolver(), Settings.System.SCREEN_BRIGHTNESS_MODE) == Settings.System.SCREEN_BRIGHTNESS_MODE_AUTOMATIC;
	...
	public static int getScreenBrightness(Context context) {
		...
		try {
			nowBrightnessValue = android.provider.Settings.System.getInt(context.getContentResolver(),
