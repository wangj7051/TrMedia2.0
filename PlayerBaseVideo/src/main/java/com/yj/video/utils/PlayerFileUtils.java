...
public class PlayerFileUtils extends JsFileUtils {
    ...
    public static void init(Context context) {
        ...
        int cjVersion = VersionController.getCjVersion();
        switch (cjVersion) {
            case 1:
            ...
            case 2:
            case 3:
                mDelegate = new CjK218Paths(cjVersion);
                break;
     ...
     * HAR_LC3110_BAS
     */
    private static final class CjK218Paths implements CjPathDelegate {
        ...
        private int mCjVersion;

        CjK218Paths(int version) {
            mCjVersion = version;
        }
